...
const colorConfig = {
  ...
  indigo: {
    iconBg: 'bg-gradient-to-br from-blue-600 to-teal-600 shadow-md',
    iconBgHover: 'group-hover:from-blue-700 group-hover:to-teal-700',
    iconColor: 'text-white',
    border: 'hover:border-blue-200',
  ...
  violet: {
    iconBg: 'bg-gradient-to-br from-blue-600 to-blue-700 shadow-md',
    iconBgHover: 'group-hover:from-blue-700 group-hover:to-blue-800',
    iconColor: 'text-white',
    border: 'hover:border-blue-200',
    metricColor: 'text-blue-700',
    badgeBg: 'bg-blue-100',
