...
const insuranceModules = [
  ...
  },
  {
    id: 'ins-m3',
    slug: 'coverage-rules',
    title: 'Government Plans & Coverage Rules',
    description: 'Understand Medicare, Medicaid, TRICARE, workers\' comp, coordination of benefits, and the insurance rules that affect every patient encounter.',
    sort_order: 3,
    quiz: {
      id: 'ins-q3',
    ...
    lessons: [
      {
        id: 'ins-l10',
        slug: 'government-plans-deep-dive',
      ...
      {
        id: 'ins-l11',
        slug: 'network-status-special-coverage',
  ...
  },
  {
    ...
    title: 'Financial Documents You\'ll See',
    description: 'Learn to read and explain the key financial documents in healthcare — EOBs, ERAs, ABNs, and the claim submission process.',
    sort_order: 4,
    quiz: {
      id: 'ins-q4',
    ...
    lessons: [
      ...
      {
        id: 'ins-l15',
        slug: 'advanced-beneficiary-notice',
  ...
  },
  {
    id: 'ins-m5',
    slug: 'revenue-cycle',
    title: 'The Revenue Cycle & Payment Models',
    description: 'Follow the money from scheduling to final payment. Understand payment models, aging reports, collections, and financial assistance programs.',
    sort_order: 5,
    quiz: {
      id: 'ins-q5',
    ...
    lessons: [
      ...
      {
        id: 'ins-l18',
        slug: 'financial-assistance-collections',
  ...
  },
  {
    ...
    description: 'Introduction to medical coding systems — ICD-10, CPT, HCPCS, SNOMED CT — and medical necessity. Short, focused lessons.',
    sort_order: 6,
    quiz: {
      id: 'ins-q6',
  ...
  },
  {
    ...
    description: 'Outbound and inbound referral workflows, prior authorization for imaging, procedures, and prescriptions, tracking, and closing the loop.',
    sort_order: 7,
    quiz: {
      id: 'ins-q7',
    ...
    lessons: [
      ...
      {
        id: 'ins-l27',
        slug: 'prior-authorization-workflows',
      ...
      {
        id: 'ins-l28',
        slug: 'auth-imaging-procedures-rx',
