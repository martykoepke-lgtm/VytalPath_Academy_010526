...
const quizzesData: Record<string, QuizData> = {
  'healthcare-delivery': {
    ...
    nextModuleSlug: 'your-role-in-healthcare',
    nextModuleFirstLesson: 'healthcare-team-roles',
    questions: [
      {
        id: 'q1-1',
        quiz_id: 'q1',
  ...
  'your-role-in-healthcare': {
    ...
    moduleTitle: 'Your Role in Healthcare',
    courseTitle: 'Healthcare Foundations',
    ...
    questions: [
      {
        id: 'qfs2-1',
        quiz_id: 'q-fs2',
        question_text: 'Which of the following professionals can examine patients, diagnose conditions, and prescribe medications — similar to a physician?',
        question_type: 'multiple_choice',
        options: [
          'A. Medical Assistant (MA)',
          'B. Nurse Practitioner (NP) or Physician Assistant (PA)',
          'C. Licensed Practical Nurse (LPN)',
          'D. Medical Administrative Assistant (MAA)',
        ],
        correct_answer: 'B',
        explanation: 'Nurse Practitioners and Physician Assistants are advanced practice providers who can examine, diagnose, prescribe, and manage patient care. In many clinics, they carry their own patient panels.',
        sort_order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-2',
        quiz_id: 'q-fs2',
        question_text: 'A patient calls and asks you whether she should stop taking her blood pressure medication because it makes her dizzy. What should you do?',
        question_type: 'multiple_choice',
        options: [
          'A. Tell her to stop taking it since she is having side effects',
          'B. Suggest she take a lower dose until her next appointment',
          'C. Let her know you will have the nurse or provider get back to her about that question',
          'D. Look up the medication and read her the side effects from the internet',
        ],
        correct_answer: 'C',
        explanation: 'Clinical questions — including medication changes — are outside the MAA scope of practice. Always route these to the nurse or provider. Never give medical advice, even if you think you know the answer.',
        sort_order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-3',
        quiz_id: 'q-fs2',
        question_text: 'Which of the following is NOT within the medical administrative assistant\'s scope of practice?',
        question_type: 'multiple_choice',
        options: [
          'A. Verifying insurance eligibility',
          'B. Interpreting lab results for a patient',
          'C. Processing referrals and prior authorizations',
          'D. Collecting copays and outstanding balances',
        ],
        correct_answer: 'B',
        explanation: 'Interpreting lab results is a clinical function reserved for providers and nurses. MAAs handle administrative tasks like scheduling, insurance verification, referrals, and payment collection.',
        sort_order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-4',
        quiz_id: 'q-fs2',
        question_text: 'A Spanish-speaking patient arrives for their appointment. Their teenage daughter offers to interpret. What is the best course of action?',
        question_type: 'multiple_choice',
        options: [
          'A. Accept — a family member is the most convenient option',
          'B. Decline and use your office\'s professional interpreter service instead',
          'C. Ask the daughter to interpret only for the consent forms',
          'D. Proceed without an interpreter since the patient signed in successfully',
        ],
        correct_answer: 'B',
        explanation: 'Never use family members — especially children — as interpreters for clinical or consent conversations. This creates HIPAA concerns and accuracy risks. Always use professional interpreter services.',
        sort_order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-5',
        quiz_id: 'q-fs2',
        question_text: 'During the patient check-in process, which of the following should be completed?',
        question_type: 'multiple_choice',
        options: [
          'A. Verify identity, update demographics, collect insurance card, obtain signatures, collect copay',
          'B. Verify identity and collect copay only',
          'C. Update demographics and schedule the follow-up appointment',
          'D. Collect signatures and review the provider\'s clinical notes from the last visit',
        ],
        correct_answer: 'A',
        explanation: 'Check-in includes: verify identity (name, DOB, photo ID), update demographics, verify/scan insurance, collect signatures (consent, financial responsibility, HIPAA), and collect the copay.',
        sort_order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-6',
        quiz_id: 'q-fs2',
        question_text: 'An elderly patient is struggling with the self-service check-in kiosk. They haven\'t asked for help. What should you do?',
        question_type: 'multiple_choice',
        options: [
          'A. Wait until they ask — you don\'t want to embarrass them',
          'B. Proactively approach and offer assistance',
          'C. Direct them to sit down and check them in yourself from behind the desk',
          'D. Tell them they must use the kiosk per office policy',
        ],
        correct_answer: 'B',
        explanation: 'Monitor the kiosk area and proactively offer help to patients who appear to be struggling. Many patients won\'t ask on their own. A manual check-in backup should always be available.',
        sort_order: 6,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-7',
        quiz_id: 'q-fs2',
        question_text: 'The front office and clinical team interact at many points during the day. Which of the following is NOT a typical front office/clinical connection point?',
        question_type: 'multiple_choice',
        options: [
          'A. Routing patient phone messages to the nurse',
          'B. Administering medications to patients',
          'C. Scheduling patients based on provider templates',
          'D. Processing referrals ordered by the provider',
        ],
        correct_answer: 'B',
        explanation: 'Administering medications is a clinical task performed by nurses, MAs, or providers — never front office staff. Routing messages, scheduling, and processing referrals are key front office/clinical connection points.',
        sort_order: 7,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-8',
        quiz_id: 'q-fs2',
        question_text: 'A visually impaired patient arrives for their appointment. What is the most appropriate way to assist with paperwork?',
        question_type: 'multiple_choice',
        options: [
          'A. Skip the paperwork since they cannot read it',
          'B. Have another patient in the waiting room read the forms to them',
          'C. Ask if they would like you to read the forms aloud, and offer large-print versions if available',
          'D. Fill out the forms yourself based on what you think their answers would be',
        ],
        correct_answer: 'C',
        explanation: 'Offer to read forms aloud or provide large-print versions. Always ask before assuming what help is needed. Consent forms must be explained thoroughly so the patient understands what they are agreeing to.',
        sort_order: 8,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-9',
        quiz_id: 'q-fs2',
        question_text: 'What happens during the pre-visit preparation stage of the patient journey?',
        question_type: 'multiple_choice',
        options: [
          'A. The provider examines the patient and documents findings',
          'B. Insurance verification, prior authorization, chart prep, and appointment reminders',
          'C. The patient pays their copay and signs consent forms',
          'D. The front office schedules the patient\'s follow-up visit',
        ],
        correct_answer: 'B',
        explanation: 'Pre-visit preparation includes verifying insurance, obtaining prior authorizations if needed, sending new patient paperwork, sending reminders, and preparing the chart — all before the patient arrives.',
        sort_order: 9,
        created_at: new Date().toISOString(),
      },
      {
        id: 'qfs2-10',
        quiz_id: 'q-fs2',
        question_text: 'Medical Administrative Assistants can authorize prescription refills without provider approval.',
        question_type: 'true_false',
        options: ['True', 'False'],
        correct_answer: 'False',
        explanation: 'MAAs cannot authorize prescription refills — this requires provider approval. The MAA\'s role is to take the refill request from the patient and route it to the provider or nurse for approval.',
        sort_order: 10,
        created_at: new Date().toISOString(),
      },
    ],
  ...
  'non-clinic-encounters': {
    ...
    courseTitle: 'EHR & Practice Management',
    nextModuleSlug: 'telehealth-portals',
    nextModuleFirstLesson: 'telehealth-appointment-types',
    questions: [
      {
        id: 'ehr-q3-1',
        quiz_id: 'ehr-q3',
  ...
  // EHR — Telehealth & Patient Portals Quiz
  'telehealth-portals': {
    quiz: {
      id: 'ehr-q4',
      module_id: 'ehr-m4',
    ...
    moduleTitle: 'Telehealth & Patient Portals',
    courseTitle: 'EHR & Practice Management',
    nextModuleSlug: null,
    nextModuleFirstLesson: null,
    questions: [
      {
        id: 'ehr-q4-1',
        quiz_id: 'ehr-q4',
        question_text: 'Which of the following visit types is generally NOT appropriate for telehealth?',
        question_type: 'multiple_choice',
        options: [
          'A. Follow-up for medication management',
          'B. Wound check requiring suture removal',
          'C. Mental health therapy session',
          'D. Review of lab results with the patient',
        ],
        correct_answer: 'B',
        explanation: 'Suture removal requires a physical procedure that cannot be done virtually. Medication follow-ups, therapy sessions, and result reviews are all well-suited for telehealth.',
        sort_order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'ehr-q4-2',
        quiz_id: 'ehr-q4',
        question_text: 'What makes a video platform HIPAA compliant for telehealth?',
        question_type: 'multiple_choice',
        options: [
          'A. It is free to use',
          'B. It has a Business Associate Agreement, encryption, and audit trails',
          'C. It is available on all smartphones',
          'D. It allows screen recording for documentation',
        ],
        correct_answer: 'B',
        explanation: 'HIPAA-compliant telehealth platforms must have a signed BAA with the clinic, end-to-end encryption, access controls, and audit trails. Being free or widely available does not make a platform compliant.',
        sort_order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'ehr-q4-3',
        quiz_id: 'ehr-q4',
        question_text: 'A patient says they can\'t get the telehealth video to work. After basic troubleshooting, what should you offer?',
        question_type: 'multiple_choice',
        options: [
          'A. Tell them to call back tomorrow',
          'B. Cancel the appointment',
          'C. Convert to a telephone (audio-only) visit or reschedule in-person',
          'D. Ask them to go to the emergency room instead',
        ],
        correct_answer: 'C',
        explanation: 'Never leave the patient without options. If video fails, offer a telephone visit (audio-only) as an immediate alternative, or reschedule as in-person. The goal is to ensure the patient receives care.',
        sort_order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'ehr-q4-4',
        quiz_id: 'ehr-q4',
        question_text: 'Under the 21st Century Cures Act, what is "information blocking"?',
        question_type: 'multiple_choice',
        options: [
          'A. A patient refusing to use the portal',
          'B. A clinic intentionally preventing patients from accessing their electronic health information',
          'C. A firewall blocking access to the EHR',
          'D. A provider declining a telehealth visit',
        ],
        correct_answer: 'B',
        explanation: 'Information blocking occurs when a clinic or health IT vendor intentionally prevents patients from accessing their electronic health information. The Cures Act prohibits this practice.',
        sort_order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'ehr-q4-5',
        quiz_id: 'ehr-q4',
        question_text: 'A patient wants their spouse to access their patient portal. What is required?',
        question_type: 'multiple_choice',
        options: [
          'A. The patient simply shares their login credentials',
          'B. Written authorization and proxy access setup',
          'C. No documentation is needed for spouses',
          'D. A court order is required',
        ],
        correct_answer: 'B',
        explanation: 'Proxy access requires written authorization from the patient. Each authorized person gets their own login — patients should never share their own credentials, as this creates audit trail issues.',
        sort_order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'ehr-q4-6',
        quiz_id: 'ehr-q4',
        question_text: 'When checking in a telehealth patient, what additional verification question should you ask compared to in-person visits?',
        question_type: 'multiple_choice',
        options: [
          'A. "What is your mother\'s maiden name?"',
          'B. "Can you confirm which state you are currently in?"',
          'C. "What brand of computer are you using?"',
          'D. "Have you eaten today?"',
        ],
        correct_answer: 'B',
        explanation: 'Providers must be licensed in the state where the patient is located during the visit. Confirming the patient\'s current state is a required telehealth verification step that doesn\'t apply to in-person visits.',
        sort_order: 6,
        created_at: new Date().toISOString(),
      },
      {
        id: 'ehr-q4-7',
        quiz_id: 'ehr-q4',
        question_text: 'A patient self-schedules a telehealth appointment through the portal. What should the front office check before the visit?',
        question_type: 'multiple_choice',
        options: [
          'A. Nothing — self-scheduled appointments are fully automated',
          'B. Insurance eligibility, correct visit type, and that it\'s not a duplicate booking',
          'C. Only the copay amount',
          'D. Whether the patient has been seen before',
        ],
        correct_answer: 'B',
        explanation: 'Self-scheduled appointments still need front office verification. Check insurance eligibility (the patient didn\'t verify during booking), confirm the visit type is correct, and make sure it\'s not a duplicate booking.',
        sort_order: 7,
        created_at: new Date().toISOString(),
      },
    ],
  ...
  'coding-basics': {
    ...
    moduleTitle: 'Coding Basics for Front Office',
    courseTitle: 'Insurance & Billing',
    nextModuleSlug: 'referrals-prior-auth',
    nextModuleFirstLesson: 'referral-fundamentals',
    questions: [
      {
        id: 'cb-q1',
        quiz_id: 'ins-q6',
        question_text: 'What is the primary purpose of ICD-10-CM codes?',
        question_type: 'multiple_choice',
        options: [
          'A. To describe procedures performed during a visit',
          'B. To classify patient diagnoses and conditions',
          'C. To determine copay amounts',
          'D. To assign provider NPI numbers',
        ],
        correct_answer: 'B',
        explanation: 'ICD-10-CM codes classify diagnoses and conditions. They tell the payer WHY the patient was seen. CPT codes describe WHAT was done.',
        sort_order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'cb-q2',
        quiz_id: 'ins-q6',
        question_text: 'A patient comes in for a follow-up on their diabetes and hypertension. The claim lists CPT code 99214 but no ICD-10 codes. What will likely happen?',
        question_type: 'multiple_choice',
        options: [
          'A. The claim will be paid at a reduced rate',
          'B. The claim will be denied — diagnosis codes are required',
          'C. The payer will assign diagnosis codes automatically',
          'D. Only the copay will be collected',
        ],
        correct_answer: 'B',
        explanation: 'Every claim must link procedure codes to diagnosis codes. Without ICD-10 codes, the payer has no way to determine medical necessity and the claim will be denied.',
        sort_order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'cb-q3',
        quiz_id: 'ins-q6',
        question_text: 'Which CPT E&M code range is used for established patient office visits?',
        question_type: 'multiple_choice',
        options: [
          'A. 99201–99205',
          'B. 99211–99215',
        ...
        correct_answer: 'B',
        explanation: 'CPT codes 99211–99215 are for established patient office/outpatient visits. 99201–99205 were for new patients (now 99202–99205). 99281–99285 are ED visits.',
        sort_order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'cb-q4',
        quiz_id: 'ins-q6',
        question_text: 'What does HCPCS Level II primarily cover that CPT does not?',
        question_type: 'multiple_choice',
        options: [
          'A. Surgical procedures',
          'B. Supplies, DME, and non-physician services',
          'C. Diagnosis classifications',
          'D. Laboratory tests',
        ],
        correct_answer: 'B',
        explanation: 'HCPCS Level II covers items not in CPT — durable medical equipment (wheelchairs, CPAP), supplies (syringes, bandages), ambulance services, and drugs administered in the office.',
        sort_order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'cb-q5',
        quiz_id: 'ins-q6',
        question_text: 'SNOMED CT is primarily used for:',
        question_type: 'multiple_choice',
        options: [
          'A. Submitting claims to insurance companies',
          'B. Clinical documentation within EHR systems',
          'C. Calculating patient copay amounts',
          'D. Scheduling appointments',
        ],
        correct_answer: 'B',
        explanation: 'SNOMED CT is a clinical terminology used inside EHR systems for detailed clinical documentation. It is NOT used for billing — ICD-10 and CPT are the billing code sets.',
        sort_order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'cb-q6',
        quiz_id: 'ins-q6',
        question_text: 'Medical necessity means:',
        question_type: 'multiple_choice',
        options: [
          'A. Any service the patient requests',
          'B. The service is clinically appropriate and required for the diagnosis',
          'C. The most expensive treatment option available',
          'D. Any service covered by the patient\'s plan',
        ],
        correct_answer: 'B',
        explanation: 'Medical necessity means the service must be clinically appropriate, required for the patient\'s condition, and supported by the diagnosis codes. Payers deny claims that lack medical necessity.',
        sort_order: 6,
        created_at: new Date().toISOString(),
      },
      {
        id: 'cb-q7',
        quiz_id: 'ins-q6',
        question_text: 'An ABN (Advance Beneficiary Notice) is used when:',
        question_type: 'multiple_choice',
        options: [
          'A. A new patient registers for the first time',
          'B. Medicare may not cover a service and the patient needs to decide whether to proceed',
          'C. A provider changes their NPI number',
          'D. The patient switches insurance plans',
        ],
        correct_answer: 'B',
        explanation: 'An ABN is given to Medicare patients BEFORE a service that Medicare may not cover. It informs the patient they may be financially responsible and lets them decide whether to proceed.',
        sort_order: 7,
        created_at: new Date().toISOString(),
      },
    ],
  },
  // Insurance — Referrals & Prior Authorization Quiz
  'referrals-prior-auth': {
    ...
    moduleTitle: 'Referrals & Prior Authorization',
    courseTitle: 'Insurance & Billing',
    nextModuleSlug: null,
    nextModuleFirstLesson: null,
    questions: [
      {
        id: 'rpa-q1',
        quiz_id: 'ins-q7',
        question_text: 'What is the key difference between an outbound referral and an inbound referral?',
        question_type: 'multiple_choice',
        options: [
          'A. Outbound referrals are for emergencies; inbound referrals are for routine visits',
          'B. Outbound means your clinic is sending the patient out; inbound means another clinic is sending a patient to you',
          'C. Outbound referrals require authorization; inbound referrals never do',
          'D. There is no difference — they are the same process',
        ],
        correct_answer: 'B',
        explanation: 'Outbound referrals are sent FROM your clinic to a specialist. Inbound referrals are received BY your clinic from a referring provider. Both may require authorization depending on the patient\'s insurance.',
        sort_order: 1,
        created_at: new Date().toISOString(),
      },
      {
        id: 'rpa-q2',
        quiz_id: 'ins-q7',
        question_text: 'A patient has an HMO plan. Their PCP wants them to see a dermatologist. What must happen before the specialist visit?',
        question_type: 'multiple_choice',
        options: [
          'A. Nothing — the patient can self-refer to any specialist',
          'B. The PCP must issue a formal referral, and prior authorization may also be required',
          'C. The patient must switch to a PPO plan first',
          'D. The dermatologist must contact the PCP directly',
        ],
        correct_answer: 'B',
        explanation: 'HMO plans typically require a formal referral from the PCP before seeing a specialist. Additionally, prior authorization from the payer may be needed. Without these, the visit may not be covered.',
        sort_order: 2,
        created_at: new Date().toISOString(),
      },
      {
        id: 'rpa-q3',
        quiz_id: 'ins-q7',
        question_text: 'When is a referral considered "closed"?',
        question_type: 'multiple_choice',
        options: [
          'A. When the referral order is placed',
          'B. When the patient schedules the appointment',
          'C. When the patient attends the visit AND consult notes are received by the referring provider',
          'D. When the authorization is approved',
        ],
        correct_answer: 'C',
        explanation: 'A referral isn\'t complete until the loop is closed: the patient has been seen AND consult notes have been sent back to the referring provider. This is the most commonly missed step.',
        sort_order: 3,
        created_at: new Date().toISOString(),
      },
      {
        id: 'rpa-q4',
        quiz_id: 'ins-q7',
        question_text: 'A prior authorization request is denied because "medical necessity not established." What is the BEST next step?',
        question_type: 'multiple_choice',
        options: [
          'A. Tell the patient their insurance won\'t cover it',
          'B. Resubmit the exact same request',
          'C. Request a peer-to-peer review so the provider can discuss the case with the payer\'s medical director',
          'D. Schedule the procedure anyway and bill the patient',
        ],
        correct_answer: 'C',
        explanation: 'A peer-to-peer review allows your provider to speak directly with the payer\'s reviewing physician to explain the clinical reasoning. This is often the fastest way to overturn a medical necessity denial.',
        sort_order: 4,
        created_at: new Date().toISOString(),
      },
      {
        id: 'rpa-q5',
        quiz_id: 'ins-q7',
        question_text: 'The payer requires "step therapy" before approving a specialty medication. What does this mean?',
        question_type: 'multiple_choice',
        options: [
          'A. The patient must walk to the pharmacy to pick up the medication',
          'B. The patient must try and fail cheaper/simpler medications before the expensive one is approved',
          'C. The medication must be administered in small, incremental doses',
          'D. The provider must prescribe the medication in writing, not electronically',
        ],
        correct_answer: 'B',
        explanation: 'Step therapy requires that the patient try (and document failure of) lower-cost or first-line treatments before the payer will authorize more expensive options. The chart must document what was tried and why it didn\'t work.',
        sort_order: 5,
        created_at: new Date().toISOString(),
      },
      {
        id: 'rpa-q6',
        quiz_id: 'ins-q7',
        question_text: 'An MRI authorization was approved 75 days ago but the patient hasn\'t been scheduled yet. The auth expires at 90 days. What should you do?',
        question_type: 'multiple_choice',
        options: [
          'A. Nothing — the auth is still valid',
          'B. Immediately schedule the MRI and contact the patient to ensure it happens before expiration',
          'C. Let it expire and submit a new auth request',
          'D. Change the expiration date in your tracking log',
        ],
        correct_answer: 'B',
        explanation: 'With only 15 days left, you need to schedule immediately and contact the patient. If the auth expires, you\'ll need to start the entire authorization process over, delaying patient care.',
        sort_order: 6,
        created_at: new Date().toISOString(),
      },
      {
        id: 'rpa-q7',
        quiz_id: 'ins-q7',
        question_text: 'Which of the following is the correct order for the formal appeals process after a prior auth denial?',
        question_type: 'multiple_choice',
        options: [
          'A. External review → Internal appeal → State insurance commissioner',
          'B. Internal appeal → External review (after internal appeals exhausted)',
          'C. State insurance commissioner → Internal appeal → External review',
          'D. Peer-to-peer → Resubmit → Ignore the denial',
        ],
        correct_answer: 'B',
        explanation: 'The formal appeals process starts with internal appeals to the payer. If internal appeals are denied, the next step is an external review by an independent third party. The state insurance commissioner can be contacted at any time.',
        sort_order: 7,
        created_at: new Date().toISOString(),
      },
    ],
  },
  // Workflows - Administrative Procedures Quiz
  'admin-procedures': {
    quiz: {
      id: 'ap-q1',
      module_id: 'ap-m1',
    ...
    moduleTitle: 'Administrative Procedures',
    courseTitle: 'Front Office Workflows',
    nextModuleSlug: null,
    nextModuleFirstLesson: null,
    questions: [
      {
        id: 'ap-q1-1', quiz_id: 'ap-q1',
        question_text: 'In terminal digit filing, the medical record number 12-34-56 is filed primarily by which digits?',
        question_type: 'multiple_choice',
        options: ['A. 12 (the first two digits)', 'B. 34 (the middle two digits)', 'C. 56 (the last two digits)', 'D. The full six-digit number in sequence'],
        correct_answer: 'C',
        explanation: 'In terminal digit filing, the number is read right to left. The last two digits (56) are the primary/terminal digits that determine the file section. This system distributes records evenly across 100 sections.',
        sort_order: 1, created_at: new Date().toISOString(),
      },
      {
        id: 'ap-q1-2', quiz_id: 'ap-q1',
        question_text: 'When writing a formal medical office letter, the correct salutation format is:',
        question_type: 'multiple_choice',
        options: ['A. "Hey Dr. Chen,"', 'B. "Dear Dr. Chen:"', 'C. "Hi Sarah,"', 'D. "To Dr. Chen —"'],
        correct_answer: 'B',
        explanation: 'Formal business letters in healthcare use "Dear" followed by the recipient\'s title and last name, ending with a colon. First names and informal greetings are not appropriate for formal correspondence.',
        sort_order: 2, created_at: new Date().toISOString(),
      },
      {
        id: 'ap-q1-3', quiz_id: 'ap-q1',
        question_text: 'A patient in a wheelchair arrives for their appointment. The check-in counter is too high for them to reach. What should you do?',
        question_type: 'multiple_choice',
        options: ['A. Ask them to stand up briefly to sign in', 'B. Bring the clipboard and paperwork to them at wheelchair height', 'C. Have a family member complete the paperwork for them', 'D. Tell them to come back when the accessible counter is available'],
        correct_answer: 'B',
        explanation: 'Under the ADA, you should provide a reasonable modification by bringing the clipboard to the patient. This ensures they can complete their check-in process independently and with dignity.',
        sort_order: 3, created_at: new Date().toISOString(),
      },
      {
        id: 'ap-q1-4', quiz_id: 'ap-q1',
        question_text: 'A patient brings a dog into the clinic and says it is their service animal. You may ask which TWO questions?',
        question_type: 'multiple_choice',
        options: [
          'A. "What is your disability?" and "Do you have certification for the dog?"',
          'B. "Is this a service animal required because of a disability?" and "What task has the animal been trained to perform?"',
          'C. "Can I see the dog\'s service animal vest?" and "Who prescribed the animal?"',
          'D. "Is the dog vaccinated?" and "How long have you had the animal?"',
        ],
        correct_answer: 'B',
        explanation: 'Under the ADA, you may only ask two questions: (1) Is this a service animal required because of a disability? and (2) What task has the animal been trained to perform? You cannot ask about the disability itself, request documentation, or require a vest.',
        sort_order: 4, created_at: new Date().toISOString(),
      },
      {
        id: 'ap-q1-5', quiz_id: 'ap-q1',
        question_text: 'The EHR system goes down unexpectedly during a busy clinic day. Your first action should be to:',
        question_type: 'multiple_choice',
        options: ['A. Send all patients home and cancel the rest of the day', 'B. Wait for IT to fix it before seeing any more patients', 'C. Switch to paper-based downtime procedures using pre-printed forms', 'D. Try to fix the server yourself'],
        correct_answer: 'C',
        explanation: 'When the EHR goes down, switch immediately to paper-based downtime procedures. Every front desk should have pre-printed registration forms, paper appointment logs, and encounter forms ready. Patient care continues — just on paper until systems are restored.',
        sort_order: 5, created_at: new Date().toISOString(),
      },
      {
        id: 'ap-q1-6', quiz_id: 'ap-q1',
        question_text: 'HIPAA-compliant data backups should be performed at minimum:',
        question_type: 'multiple_choice',
        options: ['A. Monthly', 'B. Weekly', 'C. Daily', 'D. Only when the system is updated'],
        correct_answer: 'C',
        explanation: 'Critical healthcare data should be backed up at minimum daily. Many systems use real-time replication or more frequent incremental backups. At least one backup copy should be stored off-site and encrypted.',
        sort_order: 6, created_at: new Date().toISOString(),
      },
      {
        id: 'ap-q1-7', quiz_id: 'ap-q1',
        question_text: 'You receive a suspicious email that appears to be from your EHR vendor asking you to click a link to "verify your login credentials." You should:',
        question_type: 'multiple_choice',
        options: ['A. Click the link and enter your credentials since it looks official', 'B. Forward it to all staff so they can verify their credentials too', 'C. Do not click the link — report it to IT as a potential phishing attempt', 'D. Reply to the email asking if it is legitimate'],
        correct_answer: 'C',
        explanation: 'This is a classic phishing attempt. Never click links in unexpected emails asking for credentials, even if they look official. Report it to IT immediately. Legitimate vendors will never ask for credentials via email.',
        sort_order: 7, created_at: new Date().toISOString(),
      },
    ],
  },
  ...
  'workplace-safety': {
    ...
    moduleTitle: 'Workplace Safety & Compliance',
    courseTitle: 'Medical Law & Compliance',
    nextModuleSlug: 'ethics-data-security',
    nextModuleFirstLesson: 'professional-ethics-boundaries',
    questions: [
      {
        id: 'ml-q4-1', quiz_id: 'ml-q4',
        question_text: 'A patient asks you, "Do you think I need surgery for this?" The best response is:',
        question_type: 'multiple_choice',
        options: ['A. "Based on your symptoms, probably not."', 'B. "I\'m not qualified to advise on that, but I can get a message to your provider right away."', 'C. "My cousin had the same thing and didn\'t need surgery."', 'D. "Let me look at your chart and see what the doctor noted."'],
        correct_answer: 'B',
        explanation: 'Advising on whether a patient needs surgery is outside a front office professional\'s scope of practice. The correct response is to acknowledge the question and route it to clinical staff. Looking at the chart to answer clinical questions is also outside your scope.',
        sort_order: 1, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q4-2', quiz_id: 'ml-q4',
        question_text: 'Under the legal doctrine of respondeat superior, if a front office employee makes an error while performing their normal job duties:',
        question_type: 'multiple_choice',
        options: ['A. Only the employee is liable', 'B. The employer can also be held liable', 'C. Neither party is liable if it was an honest mistake', 'D. The patient must prove the employee acted intentionally'],
        correct_answer: 'B',
        explanation: 'Respondeat superior ("let the master answer") means the employer shares liability for employee actions performed within the scope of their job duties. This is why employers carry malpractice insurance.',
        sort_order: 2, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q4-3', quiz_id: 'ml-q4',
        question_text: 'OSHA\'s Bloodborne Pathogens Standard requires employers to provide Hepatitis B vaccination to at-risk employees at no cost.',
        question_type: 'true_false',
        options: ['True', 'False'],
        correct_answer: 'True',
        explanation: 'OSHA\'s BBP Standard requires employers to offer the Hepatitis B vaccine free of charge to all employees with potential occupational exposure to blood or other potentially infectious materials.',
        sort_order: 3, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q4-4', quiz_id: 'ml-q4',
        question_text: 'Which organization conducts unannounced surveys to evaluate healthcare facility quality and safety, and whose accreditation is required for Medicare reimbursement?',
        question_type: 'multiple_choice',
        options: ['A. OSHA', 'B. The Joint Commission', 'C. The OIG', 'D. The state health department'],
        correct_answer: 'B',
        explanation: 'The Joint Commission (TJC) is the primary accrediting body for healthcare organizations. Most hospitals and large clinics seek Joint Commission accreditation because CMS accepts it as meeting Medicare Conditions of Participation.',
        sort_order: 4, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q4-5', quiz_id: 'ml-q4',
        question_text: 'You notice a child in the waiting room with bruises in various stages of healing, and the parent gives inconsistent explanations. As a front office employee, you should:',
        question_type: 'multiple_choice',
        options: ['A. Confront the parent about the bruises', 'B. Ask the child directly if they are being hurt', 'C. Report your observations to your supervisor immediately and document what you saw', 'D. Wait to see if the provider notices anything during the visit'],
        correct_answer: 'C',
        explanation: 'Front office staff are mandatory reporters in most states. You should report your observations to your supervisor immediately and document factually what you saw. Never confront a suspected abuser or try to investigate — that\'s the job of trained investigators.',
        sort_order: 5, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q4-6', quiz_id: 'ml-q4',
        question_text: 'When writing an incident report, you should assign blame to the responsible party so management can take appropriate action.',
        question_type: 'true_false',
        options: ['True', 'False'],
        correct_answer: 'False',
        explanation: 'Incident reports should be factual and objective — never assign blame. Write what happened ("patient found on floor"), not your interpretation ("patient fell because nurse wasn\'t watching"). The investigation will determine contributing factors.',
        sort_order: 6, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q4-7', quiz_id: 'ml-q4',
        question_text: 'You discover a small fire in the break room. According to the RACE protocol, after rescuing anyone in immediate danger, your next step is to:',
        question_type: 'multiple_choice',
        options: ['A. Attempt to extinguish the fire', 'B. Evacuate the building', 'C. Pull the fire alarm and call 911', 'D. Close all windows'],
        correct_answer: 'C',
        explanation: 'RACE stands for Rescue, Alarm, Contain, Extinguish/Evacuate. After rescuing anyone in immediate danger, the next step is to sound the Alarm — pull the fire alarm and call 911. Then contain the fire by closing doors, and finally attempt to extinguish (if small) or evacuate.',
        sort_order: 7, created_at: new Date().toISOString(),
      },
    ],
  },
  ...
  'ethics-data-security': {
    ...
    moduleTitle: 'Ethics & Data Security',
    courseTitle: 'Medical Law & Compliance',
    nextModuleSlug: null,
    nextModuleFirstLesson: null,
    questions: [
      {
        id: 'ml-q5-1', quiz_id: 'ml-q5',
        question_text: 'A patient asks you, "Is my blood pressure medication working?" Which ethical principle requires you to route this question to clinical staff rather than answering it yourself?',
        question_type: 'multiple_choice',
        options: ['A. Justice — treating all patients fairly', 'B. Non-maleficence — avoiding harm by staying within your scope', 'C. Autonomy — respecting the patient\'s right to decide', 'D. Beneficence — acting in the patient\'s best interest'],
        correct_answer: 'B',
        explanation: 'Non-maleficence ("do no harm") requires you to avoid actions that could harm the patient. Answering clinical questions outside your scope of practice could lead to incorrect information and potential harm. Route these questions to qualified clinical staff.',
        sort_order: 1, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q5-2', quiz_id: 'ml-q5',
        question_text: 'You discover that your neighbor is a patient at your clinic. You are curious about their diagnosis but have no work-related reason to access their chart. Accessing their record would be:',
        question_type: 'multiple_choice',
        options: ['A. Acceptable since you work at the clinic', 'B. A HIPAA violation and a professional boundary violation', 'C. Acceptable as long as you don\'t share the information', 'D. Only a problem if your neighbor finds out'],
        correct_answer: 'B',
        explanation: 'Accessing a patient\'s record without a legitimate work reason is both a HIPAA violation and a professional boundary violation, regardless of whether you share the information. Audit trails will show your access, and consequences can include termination and legal penalties.',
        sort_order: 2, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q5-3', quiz_id: 'ml-q5',
        question_text: 'Which of the following is an example of a physical safeguard under HIPAA?',
        question_type: 'multiple_choice',
        options: ['A. Annual HIPAA training for all staff', 'B. Positioning monitors so patients cannot see other patients\' information', 'C. Requiring unique login credentials for each user', 'D. Designating a Security Officer'],
        correct_answer: 'B',
        explanation: 'Positioning monitors away from patient view is a physical safeguard — it protects the physical environment where PHI is displayed. Annual training (A) and designating a Security Officer (D) are administrative safeguards. Unique logins (C) are technical safeguards.',
        sort_order: 3, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q5-4', quiz_id: 'ml-q5',
        question_text: 'The #1 cause of healthcare data breaches is:',
        question_type: 'multiple_choice',
        options: ['A. Lost or stolen laptops', 'B. Phishing emails', 'C. Disgruntled employees', 'D. Paper records left in public areas'],
        correct_answer: 'B',
        explanation: 'Phishing — fraudulent emails designed to trick employees into revealing credentials or clicking malicious links — is the leading cause of healthcare data breaches. Always verify suspicious emails and report them to IT rather than clicking links.',
        sort_order: 4, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q5-5', quiz_id: 'ml-q5',
        question_text: 'When federal and state medical records retention requirements conflict, you should follow the shorter retention period to reduce breach risk.',
        question_type: 'true_false',
        options: ['True', 'False'],
        correct_answer: 'False',
        explanation: 'When federal and state requirements conflict, always follow the LONGER retention period. Destroying records too early can result in legal liability if those records are needed for litigation, audits, or continuity of care.',
        sort_order: 5, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q5-6', quiz_id: 'ml-q5',
        question_text: 'Your clinic receives notice of a pending lawsuit. The office manager tells you to continue your normal document shredding schedule. What should you do?',
        question_type: 'multiple_choice',
        options: ['A. Continue shredding as instructed by the office manager', 'B. Stop all shredding and alert the compliance officer or legal department about the legal hold', 'C. Only stop shredding documents related to the specific patient in the lawsuit', 'D. Shred everything faster before the legal hold is officially issued'],
        correct_answer: 'B',
        explanation: 'When litigation is pending or anticipated, a legal hold suspends normal destruction schedules. Destroying records under a legal hold (spoliation) can result in severe legal penalties. You should stop all destruction and notify the compliance officer or legal department immediately.',
        sort_order: 6, created_at: new Date().toISOString(),
      },
      {
        id: 'ml-q5-7', quiz_id: 'ml-q5',
        question_text: 'Which of the following is an acceptable method for destroying paper medical records containing PHI?',
        question_type: 'multiple_choice',
        options: ['A. Tearing them in half and putting them in the recycling bin', 'B. Placing them in a regular trash bag', 'C. Cross-cut shredding', 'D. Crumpling them up and throwing them away'],
        correct_answer: 'C',
        explanation: 'Cross-cut shredding is an acceptable HIPAA-compliant method for destroying paper records containing PHI. Regular trash, recycling, and simple tearing do not prevent reconstruction of the information and are HIPAA violations.',
        sort_order: 7, created_at: new Date().toISOString(),
      },
    ],
  },
